...
export default class FirstStore extends BaseTutorialStep {
  ...
  onCheckModalContent(e) {
    ...
    if (e.data.type === "storeModal") {
      ...
      content.types = content.types.filter((type) => type === "store");
  ...
  check(data) {
    ...
    return !Object
      ...
      .some((areaData) => Object.values(areaData).some((cell) => cell.type === "store"))
  }
  ...
  showModalSelect() {
    this.eventBus.dispatchEvent({type: "request-modal", data: {type: "firstStore"}})
  }
