...
export default class FirstFactory extends BaseTutorialStep {
  ...
  onCheckModalContent(e) {
    ...
    if (e.data.type === "storeModal") {
      ...
      content.types = content.types.filter((type) => type === "factory");
  ...
  check(data) {
    ...
    return !Object
      ...
      .some((areaData) => Object.values(areaData).some((cell) => cell.type === "factory"))
  }
  ...
  showModalSelect() {
    this.eventBus.dispatchEvent({type: "request-modal", data: {type: "firstFactory"}})
  }
